...
class funcoes():
    ...
    def procurar_arquivos_1(self):
        self.arquivo_1 = askopenfilename(filetypes=[('Arquivos do Excel', '*.xlsx')])
    ...
    def procurar_arquivos_2(self):
        self.arquivo_2 = askopenfilename(filetypes=[('Arquivos do Excel', '*.xlsx')])
    ...
    def relatorio_1(self):
        ...
        self.parametros_texto.place(relx=0.07, rely=0.085, relwidth=0.5, relheight=0.03)

        self.parametro_a_texto = Label(self.janelas_extras, text='a :', bg='#F0F0F0', fg='#000000')
        self.parametro_a_texto.place(relx=0.08, rely=0.115, relwidth=0.05, relheight=0.05)

        self.parametro_a = Label(self.janelas_extras, text=self.relatorio_1_variaveis[4], relief="sunken", bg='#FFFFFF', fg='#000000')
        self.parametro_a.place(relx=0.15, rely=0.118, relwidth=0.325, relheight=0.05)

        self.parametro_b_texto = Label(self.janelas_extras, text='b :', bg='#F0F0F0', fg='#000000')
        self.parametro_b_texto.place(relx=0.52, rely=0.115, relwidth=0.055, relheight=0.05)

        self.parametro_b = Label(self.janelas_extras, text=self.relatorio_1_variaveis[5], relief="sunken", bg='#FFFFFF', fg='#000000')
        self.parametro_b.place(relx=0.595, rely=0.118, relwidth=0.325, relheight=0.05)
        ...
        self.qualidade_de_aderencia_texto.place(relx=0.07, rely=0.463, relwidth=0.67, relheight=0.03)
        ...
        self.parametros_texto.place(relx=0.07, rely=0.784, relwidth=0.75, relheight=0.03)

        self.parametro_location_texto = Label(self.janelas_extras, text=location, bg='#F0F0F0', fg='#000000')
        self.parametro_location_texto.place(relx=0.07, rely=0.814, relwidth=0.065, relheight=0.05)

        self.parametro_location = Label(self.janelas_extras, text= '%.4f' % location_number, relief="sunken", bg='#FFFFFF', fg='#000000')
        self.parametro_location.place(relx=0.15, rely=0.817, relwidth=0.325, relheight=0.05)

        self.parametro_scale_texto = Label(self.janelas_extras, text=scale, bg='#F0F0F0', fg='#000000')
        self.parametro_scale_texto.place(relx=0.51, rely=0.814, relwidth=0.065, relheight=0.05)

        self.parametro_scale = Label(self.janelas_extras, text= '%.4f' % scale_number, relief="sunken", bg='#FFFFFF', fg='#000000')
        self.parametro_scale.place(relx=0.595, rely=0.817, relwidth=0.325, relheight=0.05)
        ...
        if len(self.relatorio_1_variaveis[-1]) == 3:
            ...
            self.partida_variacao_1_texto.place(relx=0.08, rely=0.868, relwidth=0.065, relheight=0.05)

            self.parametro_variacao_1 = Label(self.janelas_extras, text= '%.4f' % shape_number, relief="sunken", bg='#FFFFFF', fg='#000000')
            self.parametro_variacao_1.place(relx=0.15, rely=0.871, relwidth=0.325, relheight=0.05)
            ...
            self.parametro_variacao_2_texto.place(relx=0.52, rely=0.868, relwidth=0.065, relheight=0.05)

            self.parametro_variacao_2 = Label(self.janelas_extras, text= '%.4f' % asymmetry_number, relief="sunken", bg='#FFFFFF', fg='#000000')
            self.parametro_variacao_2.place(relx=0.595, rely=0.871, relwidth=0.325, relheight=0.05)
